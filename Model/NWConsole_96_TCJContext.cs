...
{
    public partial class NWConsole_96_TCJContext : DbContext
    {
        public NWConsole_96_TCJContext()
        {
        }

        public NWConsole_96_TCJContext(DbContextOptions<NWConsole_96_TCJContext> options)
            : base(options)
        {
        }
